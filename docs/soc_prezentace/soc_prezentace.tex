  ...
  \begin{columns}[T] % T aligns columns at the top
    \column{0.5\textwidth}
       ...
       \begin{enumerate}
           ...
           \item \textbf{Feature Extraction:} ResNet-50 (frozen) $\rightarrow$ 2048-D vector.
           \item \textbf{Compression:} PCA ($2048 \rightarrow 64$).
           \item \textbf{Classification:} VQC (6 qubits, 108 params).
       \end{enumerate}
    ...
    \column{0.5\textwidth}
      ...
      \begin{tabular}{llc}
        ...
        \midrule
        Features & ResNet-50 & 0 (frozen) \\
        Reduction & PCA & 0 (fixed) \\
        \textbf{Decision} & \textbf{VQC (6-qubit)} & \textbf{108} \\
        \bottomrule
      \end{tabular}
      \vspace{0.2cm}
...
\begin{frame}{Performance vs. Efficiency}
  ...
  \begin{columns}
      ...
      \begin{itemize}
          \item Classical MLP: 164,865 params.
          \item Quantum VQC: \textbf{108 params}.
          \item \textcolor{NTCPurple}{\textbf{Reduction: 1527$\times$}}[cite: 58].
      \end{itemize}
      
      \column{0.5\textwidth}
      \textbf{Diagnostic Accuracy (AUC):}
      \begin{itemize}
          \item Classical MLP: 0.91 AUC.
          \item Hybrid VQC: \textbf{0.74 AUC}[cite: 66].
      \end{itemize}
  \end{columns}
